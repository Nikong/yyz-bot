...
public class SauceNAOSearcher {
    ...
    public void searchImage(MessageEvent event, Integer type){
        SingleMessage singleMessage = type == TypeEnum.FRIEND.getValue()?event.getMessage().get(2):event.getMessage().get(3);
    ...
    public MessageChainBuilder search(String url, int timeout) {
        ...
        try {
            ...
            sb.append("api_key=你的API&db=999&output_type=2&numres=1&db=999&url=");
            ...
            switch (status) {
                ...
                case 201:
                    ...
                    data.forEach((key,value) ->{
                        ...
                        messages.append(key+"------->"+unicodeDecode(value.toString()));
                    });
